...
void print_real_short_fft(int r, std::vector<std::string> in_, std::vector<std::string> out_) {
	...
	case 9: {
		...
		print("const auto sr41 = sr29;\n");
		print("const auto si41 = -si35;\n");
		print("const auto sr42 = sr31;\n");
		print("const auto si42 = si37;\n");
		print("const auto sr43 = sr31;\n");
		print("const auto si43 = -si37;\n");
		print("const auto sr44 = sr33;\n");
		print("const auto si44 = si39;\n");
		print("const auto sr45 = sr33;\n");
		print("const auto si45 = -si39;\n");
		print("%s = mr0;\n", out[0]);
		print("%s = sr40;\n", out[1]);
		print("%s = si40;\n", out[2]);
		print("%s = sr43;\n", out[3]);
